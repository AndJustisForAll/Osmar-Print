...
import ROutputLayout from './../components/ROutputLayout.js'
import Salidas from './Salidas'
import Menu from "./../components/Menu"
var $ = require('jquery');

class ROutputs extends Component {
	constructor(props){
		super(props);
	...
	render(){
		return(
			...
			<ROutputLayout listar={this.listar}>
			{
	...
	listar = () =>{
		var self = this;
		$.get({
			url:'/view_outputs/'+ this.state.pagina
		}).done((data)=>{
			self.setState({
